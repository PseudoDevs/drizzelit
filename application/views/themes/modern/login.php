    ...
    <div class="login-block">
        <form method="post">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="email" name="email" placeholder="<?php echo lang('email') ?>">
                </div>
            </div>
            <div class="field">
                <label class="label"><?php echo lang('password') ?></label>
                <div class="control">
                    <input class="input" type="password" name="password" placeholder="<?php echo lang('password') ?>">
                </div>
            </div>
