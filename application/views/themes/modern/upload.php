    ...
    <div class="upload-block-inner">
        ...
        <div class="upload-block-content start-top active" id="upload">
            <div class="upload-form">
                ...
                <div class="selected-files" id="selected-files">
                    ...
                    <div class="bottom">
                        ...
                        <button class="button is-small is-info is-fullwidth"><?php echo lang('add_more_files') ?></button>
                    </div>
                </div>
            ...
            <div class="button-block">
                <button class="button is-info is-rounded" id="submit-upload" disabled="disabled"><?php echo lang('upload') ?></button>
