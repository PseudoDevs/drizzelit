                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal style-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Destruct function enabled</label>
                                <div class="col-sm-10">
                                    <select class="form-control" name="destruct_enabled">
                                        <option value="true">Yes</option>
                                        <option value="false">No</option>
                                    </select>
                                    <i>Turns on/off the destruction option in the advanced section of the upload form, the "Destruction default" will be used.</i>
                                </div>
                            </div>
                            <script>$('select[name="destruct_enabled"]').val("<?php echo $settings['destruct_enabled'] ?>");</script>

                            <div class="mb-3">
                                <label class="form-label">Share function enabled</label>
                                <div class="col-sm-10">
                                    <select class="form-control" name="share_enabled">
                                        <option value="true">Yes</option>
                                        <option value="false">No</option>
                                    </select>
                                    <i>Turns on/off the share option in the advanced section of the upload form, the "Default share type" will be used.</i>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Destruction default</label>
                                <div class="col-sm-10">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    E.g. <code>info@proxibolt.com[Info - Proxibolt],support@proxibolt.com[Support - Proxibolt]</code>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Encrypt files (<a href="https://proxibolt.zendesk.com/hc/en-us/articles/115001511049" target="_blank" style="color: blue;">More info</a>)</label>
                                <div class="col-sm-10">
